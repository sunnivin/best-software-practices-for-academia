...
% Reset footnote to be shown on each slide
\let\oldfootnote\footnote
\renewcommand\footnote[1][]{\oldfootnote[frame,#1]}

% Use square parenthesis as mark
\renewcommand\@makefnmark{\hbox{\textsuperscript{[\@thefnmark]}}}
\renewcommand\@makefntext[1]{\fontsize{4}{5}\selectfont {\usebeamercolor[fg]{footnote mark}\usebeamerfont*{footnote mark}[\@thefnmark]}\enspace\usebeamerfont*{footnote} #1}
\makeatother
